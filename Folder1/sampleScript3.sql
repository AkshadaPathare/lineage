INSERT OVERWRITE TABLE test_lineage_db.table_5
SELECT
a.col1, b.col1 AS col2, c.col3_sum AS col3, col4, d.*
FROM
test_lineage_db.table_1 a JOIN test_lineage_db.table_3 b ON a.id = b.table_1_id
LEFT JOIN
...
INSERT OVERWRITE TABLE test_lineage_db.table_7
SELECT a.col1, a.col2 + b.col2 AS col2
FROM
test_lineage_db.table_5 a
LEFT JOIN
